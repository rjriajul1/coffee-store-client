       ...
       <div>
         <div style={{backgroundImage: `url(${bannerImg})`}} className="bg-cover bg-center h-96 lg:h-[600px] w-full relative ">
            ...
            <div className='absolute text-white right-6 md:w-1/2 top-25 lg:top-50 space-y-4 p-4'>
                ...
                <p className='content-font text-secondary-content md:text-xs lg:text-xl'>It's coffee time - Sip & Savor - Relaxation in every sip! Get the nostalgia back!! Your companion of every moment!!! Enjoy the beautiful moments and make them memorable.</p>
