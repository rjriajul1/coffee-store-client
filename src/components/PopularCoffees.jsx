...
const PopularCoffees = ({initialCoffees}) => {
    ...
    return (
        <div style={{backgroundImage:`url(${bgImg})`,}} className='bg-cover'>
            ...
            <h1 className='text-primary-content text-4xl font-semibold'>Our Popular Products</h1>
           <Link to='/addCoffees'><button className='bg-primary px-5 py-2 rounded-xl border'>Add Coffee</button></Link>
            </div>
